...
},O=v("//","$"),x=v("/\\*","\\*/"),M=v("#","$");var k=Object.freeze({
...
BACKSLASH_ESCAPE:y,APOS_STRING_MODE:N,QUOTE_STRING_MODE:w,PHRASAL_WORDS_MODE:{
begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/
},COMMENT:v,C_LINE_COMMENT_MODE:O,C_BLOCK_COMMENT_MODE:x,HASH_COMMENT_MODE:M,
...
P;K(e,e.end,{key:"endScope"}),e.end=f(e.end,{joinWith:""})}})(e)}function H(e){
function n(n,t){
...
;[A,R,q,I].forEach((e=>e(i,s))),e.compilerExtensions.forEach((e=>e(i,s))),
...
const n=e[0],a=t.substr(e.index),i=m(x,e,a);if(!i)return X;const r=x
...
;throw e.mode=x,e}if("end"===r.type){const e=_(r);if(e!==X)return e}
if("illegal"===r.type&&""===o)return 1
;if(T>1e5&&T>3*r.index)throw Error("potential infinite loop, way more iterations than matches")
;return S+=o,o.length}const N=v(e)
;if(!N)throw F(o.replace("{}",e)),Error('Unknown language: "'+e+'"')
;const w=H(N);let O="",x=r||w;const M={},k=new d.__emitter(d);(()=>{const e=[]
...
language:e,value:W(t),illegal:!1,relevance:0,errorRaised:n,_emitter:k,_top:x}
...
console.warn(e)),
d.throwUnescapedHTML))throw new G("One of your code blocks includes unescaped HTML.",e.innerHTML)
...
anyNumberOfTimes:u};for(const e in k)"object"==typeof k[e]&&t(k[e])
;return Object.assign(e,k),e})({});const J=e=>({IMPORTANT:{scope:"meta",
...
illegal:/%/},y={
match:n.concat(/\b/,(N=[...me,"super"],n.concat("(?!",N.join("|"),")")),t,n.lookahead(/\(/)),
...
e.regex
;const n="[\xc0-\u02b8a-zA-Z_$][\xc0-\u02b8a-zA-Z_$0-9]*",t=n+le("(?:<"+n+"~~~(?:\\s*,\\s*"+n+"~~~)*>)?",/~~~/g,2),a={
...
contains:[i,e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,oe,e.C_BLOCK_COMMENT_MODE]
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},oe,i]}},grmr_javascript:he,
...
className:{2:"keyword"}},r={match:m(/\./,p(...we)),relevance:0
},s=we.filter((e=>"string"==typeof e)).concat(["_|0"]),o={variants:[{
className:"keyword",
match:p(...we.filter((e=>"string"!=typeof e)).concat(Ne).map(fe),...ye)}]},l={
$pattern:p(/\b\w+/,/#\w+/),keyword:s.concat(xe),literal:ve},c=[i,r,o],d=[{
match:m(/\./,p(...Me)),relevance:0},{className:"built_in",
match:m(/\b/,p(...Me),/(?=\()/)}],u={match:/->/,relevance:0},b=[u,{
...
match:m(/`/,Re,/`/)},x=[O,{className:"variable",match:/\$\d+/},{
className:"variable",match:`\\$${Te}+`}],M=[{match:/(@|#)available/,
className:"keyword",starts:{contains:[{begin:/\(/,end:/\)/,keywords:Le,
contains:[...b,h,v]}]}},{className:"keyword",match:m(/@/,p(...Ie))},{
className:"meta",match:m(/@/,Re)}],k={match:g(/\b[A-Z]/),relevance:0,contains:[{
className:"type",
...
1:"keyword",3:"title"},contains:[k],keywords:[...Oe,...ve],end:/}/}
...
const n=he(e),t=["any","void","number","boolean","string","object","never","enum"],a={
beginKeywords:"namespace",end:/\{/,excludeEnd:!0,
contains:[n.exports.CLASS_REFERENCE]},i={beginKeywords:"interface",end:/\{/,
excludeEnd:!0,keywords:{keyword:"interface extends",built_in:t},
contains:[n.exports.CLASS_REFERENCE]},r={$pattern:ce,
keyword:de.concat(["type","namespace","typedef","interface","public","private","protected","implements","declare","abstract","readonly"]),
